...
% Kind of basis for filter
global tf

%%% If Energy Based Filter Methodology (ebf == 1) then %%%%%%%%%%%%%%%%%%%%
%Filterdiags
global Fdiags
...
%%% If Spectral Vanishing Viscosity (svv == 1) then %%%%%%%%%%%%%%%%%%%%%%%
% Type of epsilon and Q for SVV
global eps_svv
global Q_svv

% Epsilons for subdomains
global Esvv
